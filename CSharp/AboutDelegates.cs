...
namespace DotNetKoans.CSharp
{
	public class AboutDelegates : Koan
	{
		...
		public void DelegatesAreReferenceTypes()
		{
			...
			BinaryOp op;
			Assert.Null(null);
            // probably supposed to be "op", returned unassigned local variable error
		}
		[Koan(2)]
		...
		public void DelegatesAreImmutable()
		{
            ...
            // previously (a, original) passing error where expected and actual were the typed the same (different instances)
		}
